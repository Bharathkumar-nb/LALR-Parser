...
#
# Created: Fri Dec 28 21:18:15 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 280, 811, 51))
        ...
        self.state_disp = QtGui.QTextBrowser(self.centralwidget)
        self.state_disp.setGeometry(QtCore.QRect(20, 340, 801, 271))
        self.state_disp.setObjectName(_fromUtf8("state_disp"))
        self.tableView = QtGui.QTableView(self.centralwidget)
        self.tableView.setGeometry(QtCore.QRect(25, 341, 801, 331))
        self.tableView.setObjectName(_fromUtf8("tableView"))
        self.plainTextEdit = QtGui.QPlainTextEdit(self.centralwidget)
        self.plainTextEdit.setGeometry(QtCore.QRect(23, 80, 381, 191))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.plainTextEdit.setFont(font)
        self.plainTextEdit.setObjectName(_fromUtf8("plainTextEdit"))
        self.textBrowser = QtGui.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(20, 340, 811, 331))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        MainWindow.setTabOrder(self.parse_table, self.state_disp)
        MainWindow.setTabOrder(self.state_disp, self.tableView)
        MainWindow.setTabOrder(self.tableView, self.textBrowser)
